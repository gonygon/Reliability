...
ra2<-function(r,Cr,Ci){
  ...
  best_cost<-min(Cn)
  best_n<-which.min(Cn)
  x<-plot(n,Cn, type = 'l',col="red",xlab="점검주기",ylab="기대비용",main="점검주기에 따른 기대비용"); abline(v=best_n,lty="dotted",col="blue");abline(h=best_cost,lty="dotted",col="blue")
